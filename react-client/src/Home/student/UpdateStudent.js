...
export class UpdateStudent extends React.Component {
    constructor(props) {
        ...
        this.state = { MidleName: this.props.location.state.MidleName, Name: this.props.location.state.Name, LastName: this.props.location.state.LastName, Address: this.props.location.state.Addres, NumberOfBooks: this.props.location.state.NumberOfBook, GroupName: this.props.location.state.GroupName, AddressError: false, NumberOfBooksError: false, isLoad: false, MidleNameError: false, NameError: false, LastNameError: false, addState: 0, isUnAuth: false }
    ...
    addFunc(e) {
        ...
        if ((this.state.NumberOfBooks.length === 0) === false&(this.state.Address.length === 0) === false & (this.state.Name.length === 0 ? true : false) === false & (this.state.LastName.length === 0 ? true : false) === false & (this.state.MidleName === null ? true : false) === false) {
            fetch('https://localhost:5001/api/student/'+this.props.location.state.Id, {
                method: 'PUT',
                headers: {
