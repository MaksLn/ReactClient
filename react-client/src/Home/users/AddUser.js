...
export class AddUser extends React.Component {
    constructor(props) {
        ...
        this.state = { Role: 'user', Password: '', Name: '', Email: '', isLoad: false, RoleError: false, PasswordError: false, NameError: false, EmailError: false, addState: 0, isUnAuth: false }
                    ...
                    <Col xs='4'>
                        ...
                        <Form method='post' size='sm'>
                            ...
                            <Form.Group style={{marginBottom:'0px'}} controlId="formBasicPassword">
                                ...
                                <Form.Control value={this.state.Password} onChange={this.onChangeYear} type='password'></Form.Control>
